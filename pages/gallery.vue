      ...
      const esUrl = (cadena) => {
        ...
        <div id="images" class="col-6 col-sm-6 col-md-6 col-lg-3">
            <div class="card my-2 overflow-hidden text-white border-0">
                ${esUrl(data.title) === false ? '<div class="type position-absolute"><small title="generación"><i class="fa-solid fa-gear"></i></small></div>' : '<div class="type position-absolute"><small title="variación"><i class="fa-solid fa-cube"></i></small></div>'}
