      ...
      <div id="images" class="col-6 col-sm-6 col-md-6 col-lg-3 elem ${type}">
        <div class="card my-1 overflow-hidden text-white border-0">
          ...
          <div class="card-body card-desc text-white">
            ${esUrl(data.title) === false ? `<h5 class="card-title">${CapitalizeFirstLetter(title)}</h5>` : `<h5 class="card-title">Variación de: <a href="${data.title}" target="_blank">${data.title.replace(/^.*[\\/]/, "")}</a></h5>`}
            ...
            <div id="comandos">
              <h5>
                <span class="badge genf fw-normal">
                  <span class="iconify" data-icon="ph:terminal-window-duotone" data-inline="false" />
                  /generar
                </span> <span class="badge varf fw-normal">
                  <span class="iconify" data-icon="ph:cube-duotone" data-inline="false" />
                  /variar
                </span> <span class="badge anif fw-normal">
                  <span class="iconify" data-icon="ph:person-simple-duotone" data-inline="false" />
                  /animeia
                </span>
              </h5>
            </div>
          </div>
          <div id="paginas-container-2" style="--clr:#ffb8fc;" class="row justify-content-center py-3" />
          <div id="gallery" class="row" />
          <div id="paginas-container" style="--clr:#ffb8fc;" class="row justify-content-center pt-3" />
        </div>
      </div>
    </div>
  </main>
