          ...
          <div class="row justify-content-center">
              <div class="col-12">
                  ...
                  <h5 id="comandos" class="fw-light">Comandos: 
                    <span class="badge fw-normal"><span class="iconify" data-icon="ph:terminal-window-duotone" data-inline="false"></span>/generar</span> <span class="badge fw-normal">/variar</span>
                  </h5>
              </div>
