      ...
      const esUrl = (cadena) => {
        ...
        <div id="images" class="col-6 col-sm-6 col-md-6 col-lg-3">
            <div class="card my-2 overflow-hidden text-white border-0">
                ...
                <div>
                  ${esUrl(data.title) === false ? '<div class="type position-absolute" title="generación"><i class="fa-solid fa-terminal"></i></div>' : '<div class="type position-absolute" title="variación"><i class="fa fa-solid fa-cube"></i></div>'}
