      ...
      const esUrl = (cadena) => {
        ...
        <div id="images" class="col-6 col-sm-6 col-md-6 col-lg-3">
            <div class="card my-2 overflow-hidden text-white border-0">
                ...
                <div>
                  ${esUrl(data.title) === false ? '<div class="type position-absolute d-flex justify-content-center align-items-center" title="generación"><span class="iconify" data-icon="ph:cube-duotone" data-inline="false"></span></div>' : '<div class="type position-absolute d-flex justify-content-center align-items-center" title="variación"><span class="iconify" data-icon="ph:code" data-inline="false"></span></div>'}
